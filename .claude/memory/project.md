...
- 2026-09-18 — 修复 Issue #263 编译终态展示、消息分组与 Todo 收尾
  ...
  - 实验边界: 0 provider、0 model token、0 Compile Session、0 evidence write；模型调用次数仍由 graph 测试固定为 1，原始 ToolMessage 与 compiler subagent 协议未变。待提交、PR、CI、合并和服务器真实编译验收。
