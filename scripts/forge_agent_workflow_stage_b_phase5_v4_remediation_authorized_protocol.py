...
import forge_agent_workflow_stage_b_phase5_v3_authorized_protocol as parent  # noqa: E402

candidate = parent.candidate

SCHEMA_VERSION = "forge-agent-workflow-stage-b-phase5-v4-remediation-authorized-1.0.0"
DOCUMENT_TYPE = "forge_agent_workflow_stage_b_phase5_v4_remediation_authorized"
ISSUE_URL = "https://github.com/WWFXL/Forge-AutoCompiler/issues/305"
AUTHORIZATION_BASELINE_COMMIT = "5765d78754be298c8da90afe9ce4a353c8d8720d"
...
PARENT_EVIDENCE_DIRECTORY = "/workspace/.compile-sessions/benchmark-evidence-agent-workflow-stage-b-phase5-v3-authorized"
PARENT_REPORT_PATH = "reports/stage-b-phase5-v3.json"
PARENT_REPORT_FILE_SHA256 = (
    "4a4b5f4610fc9f31ee0dd06285b1f2ba3ab7371a1fb9c454ac8b80ab2bb3a4aa"
)
PARENT_DECISION_PATH = "reports/stage-c-decision.json"
...
REMEDIATION_TASK_ORDER = ("uwebsockets", "c-ares", "libass")
...
MANIFEST_RELATIVE_PATH = "benchmarks/manifests/cpp-agent-workflow-stage-b-phase5-v4-remediation-authorized.json"
SCHEMA_RELATIVE_PATH = "benchmarks/schemas/forge-agent-workflow-stage-b-phase5-v4-remediation-authorized.schema.json"
PREREGISTRATION_PATH = "benchmarks/preregistrations/cpp-agent-workflow-stage-b-phase5-v4-remediation-authorized.md"
PROTOCOL_PATH = (
    "scripts/forge_agent_workflow_stage_b_phase5_v4_remediation_authorized_protocol.py"
)
RUNNER_PATH = (
    "scripts/forge_agent_workflow_stage_b_phase5_v4_remediation_authorized_runner.py"
)
EVIDENCE_DIRECTORY = "/workspace/.compile-sessions/benchmark-evidence-agent-workflow-stage-b-phase5-v4-remediation-authorized"

DEFAULT_MANIFEST = REPO_ROOT / MANIFEST_RELATIVE_PATH
DEFAULT_SCHEMA = REPO_ROOT / SCHEMA_RELATIVE_PATH


class Phase5V4RemediationAuthorizedProtocolError(RuntimeError):
    """Phase 5 v4 修复重评 identity 或允许差异发生漂移。"""
...
def _load_json(path: Path) -> dict[str, Any]:
    try:
        ...
        raise Phase5V4RemediationAuthorizedProtocolError(
            f"无法读取 JSON: {path}"
        ) from exc
...
def _parent_manifest(repo_root: Path) -> dict[str, Any]:
    ...
    if candidate.canonical_sha256(value) != PARENT_MANIFEST_CANONICAL_SHA256:
        raise Phase5V4RemediationAuthorizedProtocolError(
            "Phase 5 v3 authorized 父 identity 发生漂移"
        )
...
def _historical_success_evidence() -> dict[str, Any]:
    return {
        ...
        "decision_path": PARENT_DECISION_PATH,
...
def generate_manifest(repo_root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    value.update(
        {
            "$schema": "../schemas/forge-agent-workflow-stage-b-phase5-v4-remediation-authorized.schema.json",
    ...
    value["budget_candidate"]["batch_max_recorded_tokens"] = 900000
    value["authorization"]["model_tokens_authorized"] = 905000
    ...
    value["evidence_candidate"].update(
        {
            ...
            "batch_report": "reports/stage-b-phase5-v4-remediation.json",
    ...
    value["authorized_execution"] = {
        ...
        "attempt_id_template": "phase5-v4-remediation-{task_id}-attempt-1",
        "thread_id_prefix": "phase5-v4-remediation",
        "evaluation_id_template": "phase5-v4-remediation-{task_id}-evaluation-v4",
        ...
        "cross_run_adjudication_report": "reports/stage-b-phase5-v3-v4-cross-run-adjudication.json",
...
def validate_allowed_delta(
    ...
    if value != expected:
        raise Phase5V4RemediationAuthorizedProtocolError(
            "Phase 5 v4 包含未预注册的父 identity 差异"
        )
    inherited_keys = (
        "provider_candidate",
...
def generate_schema(manifest: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "$id": "https://github.com/WWFXL/Forge-AutoCompiler/benchmarks/schemas/forge-agent-workflow-stage-b-phase5-v4-remediation-authorized.schema.json",
        "title": "Forge Agent Workflow Stage B Phase 5 v4 remediation authorized evaluation",
        "const": manifest,
    }
...
def validate_manifest(
    ...
    if value != expected:
        raise Phase5V4RemediationAuthorizedProtocolError(
            "Phase 5 v4 remediation authorized manifest 与确定性生成结果不一致"
        )
    ...
    if authorization["model_tokens_authorized"] != expected_tokens:
        raise Phase5V4RemediationAuthorizedProtocolError(
            "Phase 5 v4 授权 token ceiling 发生漂移"
        )
    ...
    if any(independence[key] is not False for key in false_fields) or any(
        ...
        raise Phase5V4RemediationAuthorizedProtocolError("Phase 5 v4 独立性声明无效")
